...
START_ANNOVAR_MUTECT2_MT=`date '+%s'` # capture time process starts for wall clock tracking purposes.
	...
	# construct command line
		...
		CMD="singularity exec ${MITO_MUTECT2_CONTAINER} table_annovar.pl"
			CMD=${CMD}"  ${CORE_PATH}/${PROJECT}/MT_OUTPUT/MUTECT2_MT/${SM_TAG}.MUTECT2_MT_FILTERED_MASKED.vcf"
			...
			CMD=${CMD}" --vcfinput"
		CMD=${CMD}" --outfile ${CORE_PATH}/${PROJECT}/TEMP/${SM_TAG}/ANNOVAR_MT/"
...
# write out timing metrics to file
	...
	echo ${SM_TAG}_${PROJECT},E01,ANNOVAR_MUTECT2_MT,${HOSTNAME},${START_ANNOVAR_MUTECT2_MT},${END_ANNOVAR_MUTECT2_MT} \
